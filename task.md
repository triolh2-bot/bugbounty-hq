...
| BUGBT-09 | Done | Main | Added in-app rate limiting for login, submission creation, and webhooks plus audit-style security event logging for sensitive actions. Manually reviewed and verified locally. |
